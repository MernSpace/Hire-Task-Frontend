...
import {TaskListByPriority} from "../../APIRequest/APIRequest";
...
const Medium = () => {
    ...
    useEffect(()=>{
        TaskListByPriority("Medium");
    },[])


    const MediumTask = useSelector((state) => state.task.Medium)
